...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinConfig(PORT0, 3U, &port0_3_pin79_config);
		...
		const port_pin_config_t p2_10_pin_config = {
				kPORT_PullUp,
				kPORT_LowPullResistor,
				kPORT_FastSlewRate,
				kPORT_PassiveFilterDisable,
				...
				kPORT_LowDriveStrength,
				kPORT_NormalDriveStrength,
				kPORT_MuxAlt3,    // LPUART2 TXD
				kPORT_InputBufferEnable,
				kPORT_InputNormal,
				kPORT_UnlockRegister
		};
		PORT_SetPinConfig(PORT2, 10U, &p2_10_pin_config);   // 配置为 LPUART2 TXD
		const port_pin_config_t p2_11_pin_config = {
				kPORT_PullUp,
				kPORT_LowPullResistor,
				kPORT_FastSlewRate,
				kPORT_PassiveFilterDisable,
				...
				kPORT_LowDriveStrength,
				kPORT_NormalDriveStrength,
				kPORT_MuxAlt3,    // LPUART2 RXD
				kPORT_InputBufferEnable,
				kPORT_InputNormal,
				kPORT_UnlockRegister
		};
		PORT_SetPinConfig(PORT2, 11U, &p2_11_pin_config);   // 配置为 LPUART2 RXD

		
		/*LPUART1初始化*/	
		RESET_ReleasePeripheralReset(kLPUART1_RST_SHIFT_RSTn);
		const port_pin_config_t p3_12_pin_config = {
				kPORT_PullUp,
				kPORT_LowPullResistor,
				kPORT_FastSlewRate,
				kPORT_PassiveFilterDisable,
		...
		PORT_SetPinConfig(PORT3, 8U, &p3_12_pin_config);   // 配置为 LPUART1 TXD
		
		const port_pin_config_t p3_13_pin_config = {
				kPORT_PullUp,
				kPORT_LowPullResistor,
				kPORT_FastSlewRate,
				kPORT_PassiveFilterDisable,
				...
				kPORT_LowDriveStrength,
				kPORT_NormalDriveStrength,
				kPORT_MuxAlt3,    // LPUART3 RXD
				kPORT_InputBufferEnable,
				kPORT_InputNormal,
				kPORT_UnlockRegister
		};
		PORT_SetPinConfig(PORT3, 9U, &p3_13_pin_config);   // 配置为 LPUART1 RXD
    ...
    /* 配置 I2C0 (LPI2C0) 引脚
     * FRDM-MCXA156: P0_16=LPI2C0_SDA, P0_17=LPI2C0_SCL (Arduino 接口)
     */

    const port_pin_config_t i2c0_sda_config = {
        /* Internal pull-up resistor is enabled (I2C需要上拉) */
        kPORT_PullUp,
        /* Low internal pull resistor value */
        kPORT_LowPullResistor,
        /* Fast slew rate */
        kPORT_FastSlewRate,
        /* Passive input filter is disabled */
        kPORT_PassiveFilterDisable,
        /* Open drain MUST be enabled for I2C */
        kPORT_OpenDrainEnable,
        /* Low drive strength */
        kPORT_LowDriveStrength,
        ...
        kPORT_MuxAlt5,  /* P0_16 的 Alt5 功能是 LPI2C0_SDA */
        /* Digital input enabled */
        kPORT_InputBufferEnable,
        /* Digital input is not inverted */
        kPORT_InputNormal,
    ...
    /* PORT0_16 配置为 LPI2C0_SDA */
    PORT_SetPinConfig(PORT0, 16U, &i2c0_sda_config);

    const port_pin_config_t i2c0_scl_config = {
        /* Internal pull-up resistor is enabled (I2C需要上拉) */
        kPORT_PullUp,
        /* Low internal pull resistor value */
        kPORT_LowPullResistor,
        ...
        kPORT_MuxAlt5,  /* P0_17 的 Alt5 功能是 LPI2C0_SCL */
        /* Digital input enabled */
        kPORT_InputBufferEnable,
        /* Digital input is not inverted */
        kPORT_InputNormal,
    ...
    /* PORT0_17 配置为 LPI2C0_SCL */
    PORT_SetPinConfig(PORT0, 17U, &i2c0_scl_config);

    /* Release LPI2C0 reset */
